...
import static com.mygdx.game.Constants.gamestate.overworld;
import com.mygdx.game.Constants.state;
import static com.mygdx.game.Constants.state.overworld;
...
public final class Mainmenu extends GameObject{
    ...
    public Mainmenu(Stage stage , Skin skin, state state ){
        ...
        ass.load("ov.tmx",TiledMap.class);
        ass.load("board.tmx",TiledMap.class);
       ...
       newgame.addListener(new ClickListener(){
          @Override
              public void clicked(InputEvent event,float x,float y){
                  ...
                  state = state.game;
                  stage.clear();
                   shamballa = new shamballa(stage,skin,ass);
